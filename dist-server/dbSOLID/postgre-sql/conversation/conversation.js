...
function buildConversationDataAccess(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.next = 7;
              return db.collection("conversation").findOne(query);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.next = 6;
              return db.collection("conversation").findAll(query);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              db = _context3.sent;
              _context3.next = 5;
              return db.collection("conversation").create(data);
